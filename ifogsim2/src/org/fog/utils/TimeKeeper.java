...
public class TimeKeeper {
	...
	private Map<Integer, List<Double>> loopIdToLatencySamples = new HashMap<>();
	...
	public void recordLoopLatency(int loopId, double delayMs) {
		if (!loopIdToLatencySamples.containsKey(loopId)) {
			loopIdToLatencySamples.put(loopId, new ArrayList<Double>());
		}
		loopIdToLatencySamples.get(loopId).add(delayMs);
	}

	public Map<Integer, List<Double>> getLoopIdToLatencySamples() {
		return loopIdToLatencySamples;
	}
	...
	private TimeKeeper(){
		...
		loopIdToLatencySamples = new HashMap<>();
		loopIdToLatencyQoSSuccessCount = new HashMap<>();
	}
